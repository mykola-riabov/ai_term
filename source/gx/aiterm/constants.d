...
/**
 * All logs go to the file /tmp/aiterm.log, useful
...
/**
 * Compile aiterm with support for VTE method vte_terminal_get_color_background_for_draw,
...
// GetText Domain
enum AITERM_DOMAIN = "aiterm";

/**
 * Application ID
 */
enum APPLICATION_ID = "com.aiterm.Aiterm";

// Application values used in About dialog
enum APPLICATION_NAME = "Aiterm";
enum APPLICATION_VERSION = "0.1.0";
enum APPLICATION_COMMENTS = N_("A VTE based terminal emulator for Linux");
enum APPLICATION_ICON_NAME = "com.aiterm.Aiterm";
...
//Config Folder
enum APPLICATION_CONFIG_FOLDER = "aiterm";

//RESOURCES
enum APPLICATION_RESOURCES = buildPath(APPLICATION_CONFIG_FOLDER, "resources/aiterm.gresource");
enum APPLICATION_RESOURCE_ROOT = "/com/aiterm/Aiterm";
immutable string[] APPLICATION_CSS_RESOURCES = ["css/aiterm.base.css","css/aiterm.base320.css"];
immutable string[] THEME_CSS_RESOURCES = ["css/aiterm.base.theme.css"];
